...
final class ActionButtons
{
     ...
     * desktop and at the foot of the screen on a phone; WhatsApp, the
     * telephone and the map are phone things, and live at the foot of the
     * screen where a thumb is; the business's own button — "About us" until
     * they change it — is under the headline on both. Nothing is in the menu,
     * which is a list of places on the page and not a place for a button.
     *
