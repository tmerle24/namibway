...
class ItineraryService
{
    ...
    private function systemPrompt(): string
    {
        ...
        return <<<PROMPT
            ...
            Use the search_listings tool to find real accommodations, activities, and restaurants —
            you MUST base every day of the plan only on listings returned by search_listings. Never invent
            a property, activity, or restaurant name that wasn't returned by the tool. Call search_listings
            as many times as you need (different types/regions) before building the plan.
    ...
    private function tools(): array
    {
        return [
            [
                ...
                'description' => 'Search NamibWay\'s real listing catalog for accommodations, activities, or restaurants.',
                'input_schema' => [
                    'type' => 'object',
                    'properties' => [
                        'type' => ['type' => 'string', 'enum' => ['accommodation', 'activity', 'restaurant']],
