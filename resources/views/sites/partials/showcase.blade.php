...
@php ob_start(); @endphp
    ...
    @media (min-width: 900px) {
        ...
        .sc .scene::after {
            content: ''; position: absolute; z-index: -1; left: -95%; right: -35%; bottom: -14%; height: 16%;
        ...
        .sc .scene__side { height: 34%; left: -80%; bottom: -7%; animation: scUp 1.4s var(--ease-out) 1.4s both; }
    }
