...
<template>
    <Head title="NamibWay — The smartest way to experience Namibia" />
    ...
    <div class="kaia-page">
        ...
        <footer>
            NamibWay — AI-assisted travel planning for Namibia. The chat interview above is a preview flow; live
