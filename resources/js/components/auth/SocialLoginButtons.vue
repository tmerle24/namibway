...
<template>
    <div class="flex flex-col gap-4">
        <div class="relative flex items-center">
            ...
            <span class="absolute left-1/2 -translate-x-1/2 bg-background px-2 text-xs text-muted-foreground">
                {{ label }}
            </span>
        </div>
        <div class="grid grid-cols-2 gap-3">
            ...
            >
                <svg class="size-4" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <path fill="#34A853" d="M12 24c3.24 0 5.96-1.07 7.94-2.91l-3.87-3c-1.08.72-2.45 1.15-4.07 1.15-3.13 0-5.78-2.11-6.73-4.95H1.27v3.11A12 12 0 0 0 12 24Z" />
            ...
            >
                <svg class="size-4" viewBox="0 0 24 24" aria-hidden="true">
                    <path fill="#1877F2" d="M24 12.07C24 5.72 18.63.5 12 .5S0 5.72 0 12.07C0 17.8 4.39 22.55 10.13 23.5v-8.1H7.08v-3.33h3.05V9.41c0-3.01 1.79-4.68 4.53-4.68 1.31 0 2.68.24 2.68.24v2.94h-1.51c-1.49 0-1.96.93-1.96 1.88v2.28h3.33l-.53 3.33h-2.8v8.1C19.61 22.55 24 17.8 24 12.07Z" />
                </svg>
                Facebook
            </a>
        </div>
